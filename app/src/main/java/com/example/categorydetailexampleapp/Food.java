...
public class Food implements Parcelable {
    ...
    public static final Food[] myBreakfast = {
            new Food("Toast", 7.99, "2 Pieces, Golden Brown, Honey-Coated", R.drawable.toast),
            new Food("Bagel", 4.99, "1 Bagel, Cream Cheese", R.drawable.bagel),
            new Food("Pie", 5.99, "1 Slice, Apple Filling", R.drawable.pie)
    ...
    public static final Food[] myLunch = {
            ...
            new Food("Noodles", 8.99, "1 Bowl, Spicy", R.drawable.noodles)
    };
    ...
    public static final Food[] myDinner = {
            ...
            new Food("Chicken Tenders", 8.99, "7 Pieces, Barbecue Sauce", R.drawable.chicken)
    };
